...
from Pokemonxd.modules.core.call import poke, autoend
from Pokemonxd.modules.database import (get_client, is_active_chat,
                                       is_autoend)
...
async def auto_leave():
    if config.AUTO_LEAVING_ASSISTANT == str(True):
        while not await asyncio.sleep(
            ...
            from pokeMusic.core.userbot import assistants
