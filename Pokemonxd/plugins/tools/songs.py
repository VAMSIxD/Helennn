...
from Pokemonxd.utilities.config import (BANNED_USERS, SONG_DOWNLOAD_DURATION,
...
from Pokemonxd.modules.utils.formatters import convert_bytes
from Pokemonxd.utilities.inline.song import song_markup
        ...
        [
            [
                InlineKeyboardButton(
                    text=_["SG_B_1"],
                    url=f"https://t.me/{bot.username}?start=song",
                ),
            ]
        ]
    )
