...
from Pokemonxd.modules.utils import (pokebin, get_channeplayCB,
                              seconds_to_min)
from Pokemonxd.modules.database import (get_cmode, is_active_chat,
                                       is_music_playing)
...
from Pokemonxd.utilities.inline import queue_back_markup, queue_markup
