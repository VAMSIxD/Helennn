...
from Pokemonxd.utilities.config import BANNED_USERS, MUSIC_BOT_NAME, adminlist, lyrical
...
from Pokemonxd.modules.database import get_authuser_names, get_cmode
from Pokemonxd.modules.decorators import (ActualAdminCB, AdminActual,
                                         language)
from Pokemonxd.modules.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await poke.stop_stream(message.chat.id)
    except:
        pass
