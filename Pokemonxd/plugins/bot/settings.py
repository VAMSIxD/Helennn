...
from Pokemonxd.utilities.config import (BANNED_USERS, CLEANMODE_DELETE_MINS,
                    MUSIC_BOT_NAME, OWNER_ID)
from Pokemonxd.utilities.strings import get_command
from Pokemonxd import bot
from Pokemonxd.modules.database import (add_nonadmin_chat,
