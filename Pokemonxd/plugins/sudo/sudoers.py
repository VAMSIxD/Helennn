...
from Pokemonxd.utilities.config import BANNED_USERS, MONGO_DB_URL, OWNER_ID
from Pokemonxd.utilities.strings import get_command
from Pokemonxd import bot
from Pokemonxd.misc import SUDOERS
from Pokemonxd.modules.database import add_sudo, remove_sudo
...
async def useradd(client, message: Message, _):
    if MONGO_DB_URL is None:
        return await message.reply_text(
            "**Due to bot's privacy issues, You can't manage sudo users when you're using poke's Database.\n\n Please fill your MONGO_DB_URL in your vars to use this feature**"
        )
