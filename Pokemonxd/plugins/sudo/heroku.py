...
from Pokemonxd.misc import HAPP, SUDOERS, XCB
from Pokemonxd.modules.database import (get_active_chats,
                                       remove_active_chat,
...
async def restart_(_, message):
    ...
    os.system(f"kill -9 {os.getpid()} && python3 -m Pokemonxd")
