...
from Pokemonxd.utilities.config import MUSIC_BOT_NAME, YOUTUBE_IMG_URL
...
async def gen_thumb(videoid):
    ...
    try:
        ...
        image2 = Image.open(f"Pokemonxd/resource/{images}.png")
        ...
        font = ImageFont.truetype("Pokemonxd/resource/font.otf", 32)
        ...
        draw.text((190, 675), f"Powered By: Blackcat (@pokemonnxd)", (255, 255, 255), font=font)
        try:
