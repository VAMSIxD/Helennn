...
async def gen_thumb(videoid):
    try:
        ...
        if 1==1:
            ...
            circle = Image.open("Pokemonxd/resource/amala.png")
            ...
            # fonts
            font1 = ImageFont.truetype('Pokemonxd/resource/font.ttf', 30)
            font2 = ImageFont.truetype('Pokemonxd/resource/font2.ttf', 70)
            font3 = ImageFont.truetype('Pokemonxd/resource/font2.ttf', 40)
            font4 = ImageFont.truetype('Pokemonxd/resource/font2.ttf', 35)
