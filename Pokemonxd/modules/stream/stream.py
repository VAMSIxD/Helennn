...
from Pokemonxd.utilities.inline.play import (stream_markup,
                                              telegram_markup)
from Pokemonxd.utilities.inline.playlist import close_markup
from Pokemonxd.modules.utils.pastebin import pokebin
from Pokemonxd.modules.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await poke.force_stop_stream(chat_id)
